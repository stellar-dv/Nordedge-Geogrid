...
import { PlusCircle, Search, X, MapPin, Calendar, BarChart2, TrendingUp, Filter, Grid, Loader2 } from "lucide-react"
...
export function DashboardHome() {
  ...
  return (
    <div className="container mx-auto pt-24 pb-10 px-4">
      ...
      {/* Detailed Grid View Dialog */}
      {selectedGridResult && (
        <DetailedGridView
          gridResult={{
            ...selectedGridResult,
            gridSize: Number(selectedGridResult.gridSize),
            metrics: {
              ...selectedGridResult.metrics,
              solv: Number(selectedGridResult.metrics.solv)
            }
          }}
          isOpen={!!selectedGridResult}
          onClose={() => setSelectedGridResult(null)}
          onDelete={() => handleDelete(selectedGridResult.id)}
        />
      )}
    </div>
  )
